...
export class DataService {
  ...
  getRankings(): Array<Object> {
    ...
    return [
      ...
      { id: 5, name: 'Dinith', points: 0, matches: 1, win: 0, loss: 0, draw: 1, rating: 0 },
      { id: 6, name: 'Chathura', points: 12, matches: 1, win: 1, loss: 0, draw: 0, rating: 0 },
      ...
      { id: 11, name: 'Ishan', points: -3, matches: 1, win: 0, loss: 1, draw: 0, rating: 0 },
      { id: 12, name: 'Anuradha', points: -15, matches: 1, win: 0, loss: 1, draw: 0, rating: 0 },
    ].map(function(p){
